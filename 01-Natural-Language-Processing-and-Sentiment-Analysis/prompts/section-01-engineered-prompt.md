# STEP 2 — Engineered Prompt for Section 1 (Natural Language Processing & Sentiment Analysis)
...
* Teach how to explain the NLP pipeline stages and what each contributes to trend measurement, characterize trend-relevant text sources with their collection biases.

* Teach how to map trend tasks to linguistic levels.

* Teach how to set up a working text-analysis environment.

* Teach how to articulate what can and cannot be validly inferred from text at scale.
...
1. Explain the NLP pipeline stages and what each contributes to trend measurement, characterize trend-relevant text sources with their collection biases, applied to a realistic scenario provided with the exercise.

2. Map trend tasks to linguistic levels, applied to a realistic scenario provided with the exercise.

3. Set up a working text-analysis environment, applied to a realistic scenario provided with the exercise.

4. Articulate what can and cannot be validly inferred from text at scale, applied to a realistic scenario provided with the exercise.
...
End the module with actionable professional checklists — a explain-the-nlp-pipeline checklist, a map-trend-tasks-to checklist, a set-up-a-working checklist, a articulate-what-can-and checklist — that a practitioner could actually use before real-world delivery.
