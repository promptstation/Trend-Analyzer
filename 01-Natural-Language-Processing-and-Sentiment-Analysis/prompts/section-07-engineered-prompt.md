# STEP 2 — Engineered Prompt for Section 7 (Natural Language Processing & Sentiment Analysis)
...
Develop a comprehensive, professional-level learning module on **“Emotion, Aspect-Based, and Stance Analysis”** as a core intermediate stage of a curriculum in natural language processing and sentiment analysis for trend intelligence — processing millions of social media posts, reviews, and search queries to measure the emotional undercurrents of the public. Teach fine-grained opinion mining: emotion frameworks — discrete models (Ekman's basic emotions and their critiques, Plutchik's wheel), dimensional models (valence-arousal-dominance), and appraisal traditions, with the measurement controversy over whether text classifiers can validly detect felt emotion versus expressed affect language; emotion datasets and their annotation problems; aspect-based sentiment analysis — aspect extraction plus aspect-level sentiment (the SemEval ABSA lineage), applied to product reviews and brand feedback ("battery great, screen dim"); stance detection — favor/against/neutral toward a target, distinct from sentiment (supporting a claim versus liking it), with rumor-stance applications; intensity and comparative sentiment; intent and complaint mining for product intelligence; high-arousal emotions (anger, awe, anxiety, amusement) and their documented sharing advantage as the bridge to virality analysis; designing multi-label taxonomies for monitoring products; and evaluating fine-grained tasks where human agreement is low — soft labels and distributional annotation. The module should assume the learner is progressing from competent beginner toward expert practitioner, and should function simultaneously as a learning resource, a practical reference, and a working methodology.
...
* Teach how to select and apply emotion frameworks with awareness of validity limits.

* Teach how to implement aspect-based sentiment pipelines for reviews and brand feedback.

* Teach how to distinguish and model stance versus sentiment versus emotion.

* Teach how to design multi-label taxonomies for trend monitoring, and connect arousal-emotion findings to predictions about content spread.
...
1. Select and apply emotion frameworks with awareness of validity limits, applied to a realistic scenario provided with the exercise.

2. Implement aspect-based sentiment pipelines for reviews and brand feedback, applied to a realistic scenario provided with the exercise.

3. Distinguish and model stance versus sentiment versus emotion, applied to a realistic scenario provided with the exercise.

4. Design multi-label taxonomies for trend monitoring, and connect arousal-emotion findings to predictions about content spread, applied to a realistic scenario provided with the exercise.
...
End the module with actionable professional checklists — a select-and-apply-emotion checklist, a implement-aspect-based-sentiment checklist, a distinguish-and-model-stance checklist, a design-multi-label-taxonomies checklist — that a practitioner could actually use before real-world delivery.
