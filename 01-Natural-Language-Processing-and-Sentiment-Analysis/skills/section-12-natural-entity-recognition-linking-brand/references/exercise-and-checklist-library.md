# Exercise and Checklist Library — Entity Recognition, Linking, and Brand Monitoring
...
## Exercise 1 — Apply and fine-tune NER for noisy social text including emerging entities and aliases
...
**Objective:** apply and fine-tune NER for noisy social text including emerging entities and aliases, link and canonicalize entities against knowledge bases.
...
## Exercise 2 — Build brand mention and share-of-voice monitoring with bias awareness
**Scenario:** provide a realistic NLP and sentiment analysis scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** build brand mention and share-of-voice monitoring with bias awareness.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.

## Exercise 3 — Extract product and feature signals from review text
**Scenario:** provide a realistic NLP and sentiment analysis scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** extract product and feature signals from review text, and connect entity data to co-mention network analysis within privacy boundaries.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.
...
## B1. Apply and fine tune NER checklist
- [ ] Apply and fine-tune NER for noisy social text including emerging entities and aliases, link and canonicalize entities against knowledge bases?
- [ ] Decisions and their justification are documented for review by a colleague

## B2. Build brand mention and checklist
- [ ] Build brand mention and share-of-voice monitoring with bias awareness?
- [ ] Decisions and their justification are documented for review by a colleague

## B3. Extract product and feature checklist
- [ ] Extract product and feature signals from review text, and connect entity data to co-mention network analysis within privacy boundaries?
- [ ] Decisions and their justification are documented for review by a colleague
