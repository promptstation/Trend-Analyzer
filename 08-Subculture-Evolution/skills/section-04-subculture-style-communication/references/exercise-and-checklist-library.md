# Exercise and Checklist Library — Style as Communication: Semiotics of Subcultural Appearance
...
## Exercise 1 — Decompose subcultural style into component systems and read meaning by contrast
...
**Objective:** decompose subcultural style into component systems and read meaning by contrast.
...
## Exercise 2 — Perform homology and bricolage analyses linking values to style choices
**Scenario:** provide a realistic Subculture evolution scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** perform homology and bricolage analyses linking values to style choices.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.

## Exercise 3 — Identify insider competence markers and micro-signals outsiders miss
**Scenario:** provide a realistic Subculture evolution scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** identify insider competence markers and micro-signals outsiders miss, document digital and physical style systems with ethnographic inventories.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.

## Exercise 4 — Distinguish identity-committed style from seasonal fashion adoption
**Scenario:** provide a realistic Subculture evolution scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** distinguish identity-committed style from seasonal fashion adoption.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.
...
## B1. Decompose subcultural style into checklist
- [ ] Decompose subcultural style into component systems and read meaning by contrast?
- [ ] Decisions and their justification are documented for review by a colleague

## B2. Perform homology and bricolage checklist
- [ ] Perform homology and bricolage analyses linking values to style choices?
- [ ] Decisions and their justification are documented for review by a colleague

## B3. Identify insider competence markers checklist
- [ ] Identify insider competence markers and micro-signals outsiders miss, document digital and physical style systems with ethnographic inventories?
- [ ] Decisions and their justification are documented for review by a colleague

## B4. Distinguish identity committed style from checklist
- [ ] Distinguish identity-committed style from seasonal fashion adoption?
- [ ] Decisions and their justification are documented for review by a colleague
