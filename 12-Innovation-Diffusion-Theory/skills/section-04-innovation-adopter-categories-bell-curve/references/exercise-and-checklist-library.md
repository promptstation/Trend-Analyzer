# Exercise and Checklist Library — Adopter Categories and the Bell Curve
...
## Exercise 1 — Apply the five adopter categories as timing positions with network and decision-style characteristics
...
**Objective:** apply the five adopter categories as timing positions with network and decision-style characteristics.
...
## Exercise 2 — Analyze opinion-leadership and change-agent roles in majority crossing
**Scenario:** provide a realistic Innovation diffusion scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** analyze opinion-leadership and change-agent roles in majority crossing, handle homophily-heterophily dynamics at segment boundaries.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.

## Exercise 3 — Diagnose bell-curve deviations (bimodal
**Scenario:** provide a realistic Innovation diffusion scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** diagnose bell-curve deviations (bimodal, skewed, inverted patterns) across cultures and mandates.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.

## Exercise 4 — Map a customer base's adopter composition to determine diffusion stage and next-segment requirements
**Scenario:** provide a realistic Innovation diffusion scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** map a customer base's adopter composition to determine diffusion stage and next-segment requirements.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.
...
## B1. Apply the five adopter checklist
- [ ] Apply the five adopter categories as timing positions with network and decision-style characteristics?
- [ ] Decisions and their justification are documented for review by a colleague

## B2. Analyze opinion leadership and change agent checklist
- [ ] Analyze opinion-leadership and change-agent roles in majority crossing, handle homophily-heterophily dynamics at segment boundaries?
- [ ] Decisions and their justification are documented for review by a colleague

## B3. Diagnose bell curve deviations (bimodal, checklist
- [ ] Diagnose bell-curve deviations (bimodal, skewed, inverted patterns) across cultures and mandates?
- [ ] Decisions and their justification are documented for review by a colleague

## B4. Map a customer base's checklist
- [ ] Map a customer base's adopter composition to determine diffusion stage and next-segment requirements?
- [ ] Decisions and their justification are documented for review by a colleague
