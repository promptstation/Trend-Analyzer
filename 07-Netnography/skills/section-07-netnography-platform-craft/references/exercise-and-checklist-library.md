# Exercise and Checklist Library — Platform Craft: Netnography Across TikTok, Discord, Reddit, Instagram, and Games
...
## Exercise 1 — Adapt fieldwork to platform affordances (FYP personalization
...
**Objective:** adapt fieldwork to platform affordances (FYP personalization, Discord gates, subreddit governance, Stories ephemerality, Twitch chat), collect interaction data from platform-native forms (duets, quote-posts, votes, livestreams), scope realistic multi-platform immersion.
...
## Exercise 2 — Compare phenomena across platforms to isolate platform effects
**Scenario:** provide a realistic Netnography scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** compare phenomena across platforms to isolate platform effects, and document one's own platform fluency as an interpretive condition.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.
...
## B1. Adapt fieldwork to platform checklist
- [ ] Adapt fieldwork to platform affordances (FYP personalization, Discord gates, subreddit governance, Stories ephemerality, Twitch chat), collect interaction data from platform-native forms (duets, quote-posts, votes, livestreams), scope realistic multi-platform immersion?
- [ ] Decisions and their justification are documented for review by a colleague

## B2. Compare phenomena across platforms checklist
- [ ] Compare phenomena across platforms to isolate platform effects, and document one's own platform fluency as an interpretive condition?
- [ ] Decisions and their justification are documented for review by a colleague
