...
```markdown
# Community Detection and Group Structure [— audience/context subtitle]
...
The goal is not more content about network science. The goal is that a practitioner could take this material and perform: Apply Louvain/Leiden, Infomap, and label propagation with understanding of each objective, distinguish algorithmic partitions from social phenomena like scenes and echo chambers — with the same evidence discipline the field's best practitioners use. The module must function simultaneously as a learning resource, a practical reference, and a working methodology.
