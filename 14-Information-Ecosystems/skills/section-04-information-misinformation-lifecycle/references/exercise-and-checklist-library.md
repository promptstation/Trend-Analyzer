# Exercise and Checklist Library — The Misinformation Lifecycle: Creation to Correction
...
## Exercise 1 — Classify misinformation events across the seven lifecycle stages (creation through persistence) with speed-variance awareness
**Scenario:** provide a realistic Information ecosystems scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** classify misinformation events across the seven lifecycle stages (creation through persistence) with speed-variance awareness.
...
## Exercise 2 — Trace amplification ladders identifying which channels and elites escalate claims
**Scenario:** provide a realistic Information ecosystems scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** trace amplification ladders identifying which channels and elites escalate claims.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.

## Exercise 3 — Analyze cross-platform migration with legitimacy-accretion patterns
**Scenario:** provide a realistic Information ecosystems scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** analyze cross-platform migration with legitimacy-accretion patterns, match interventions to lifecycle stages with correction-asymmetry realism, and reconstruct claim lineages with first-seen and mutation tracking.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.
...
## B1. Classify misinformation events across checklist
- [ ] Classify misinformation events across the seven lifecycle stages (creation through persistence) with speed-variance awareness?
- [ ] Decisions and their justification are documented for review by a colleague

## B2. Trace amplification ladders identifying checklist
- [ ] Trace amplification ladders identifying which channels and elites escalate claims?
- [ ] Decisions and their justification are documented for review by a colleague

## B3. Analyze cross platform migration with checklist
- [ ] Analyze cross-platform migration with legitimacy-accretion patterns, match interventions to lifecycle stages with correction-asymmetry realism, and reconstruct claim lineages with first-seen and mutation tracking?
- [ ] Decisions and their justification are documented for review by a colleague
