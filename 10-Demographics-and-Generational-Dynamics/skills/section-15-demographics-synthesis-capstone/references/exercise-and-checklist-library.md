# Exercise and Checklist Library — Synthesis and Capstone: Demographic Trend Analysis
...
## Exercise 1 — Execute the complete demographic trend-analysis workflow from question to strategy memo
...
**Objective:** execute the complete demographic trend-analysis workflow from question to strategy memo.
...
## Exercise 2 — Apply the five-discipline standard as an audit checklist for demographic claims
**Scenario:** provide a realistic Demographics and generations scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** apply the five-discipline standard as an audit checklist for demographic claims, decompose worked cases (youth-bulge windows, aging markets, cohort consumption shifts) into method components, monitor demographic revision cycles and leading indicators.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.

## Exercise 3 — Communicate probabilistic demographic futures with calibrated confidence and determinism avoidance
**Scenario:** provide a realistic Demographics and generations scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** communicate probabilistic demographic futures with calibrated confidence and determinism avoidance.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.
...
## B1. Execute the complete demographic checklist
- [ ] Execute the complete demographic trend-analysis workflow from question to strategy memo?
- [ ] Decisions and their justification are documented for review by a colleague

## B2. Apply the five discipline standard checklist
- [ ] Apply the five-discipline standard as an audit checklist for demographic claims, decompose worked cases (youth-bulge windows, aging markets, cohort consumption shifts) into method components, monitor demographic revision cycles and leading indicators?
- [ ] Decisions and their justification are documented for review by a colleague

## B3. Communicate probabilistic demographic futures checklist
- [ ] Communicate probabilistic demographic futures with calibrated confidence and determinism avoidance?
- [ ] Decisions and their justification are documented for review by a colleague
