...
```markdown
# State-Space, Structural, and Bayesian Time-Series Models [— audience/context subtitle]
...
The goal is not more content about Time-series forecasting. The goal is that a practitioner could take this material and perform: Apply state-space and structural time-series models with Kalman filtering intuition, select statistical model families by interpretability and data conditions — with the same evidence discipline the field's best practitioners use. The module must function simultaneously as a learning resource, a practical reference, and a working methodology.
