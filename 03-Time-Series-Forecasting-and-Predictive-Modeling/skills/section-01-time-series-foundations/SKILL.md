...
```markdown
# Foundations: Time Series, Components, and the Fad-Versus-Trend Question [— audience/context subtitle]
...
The goal is not more content about Time-series forecasting. The goal is that a practitioner could take this material and perform: Frame trend questions as component-decomposition and forecast problems, set forecast horizons matched to decision needs — with the same evidence discipline the field's best practitioners use. The module must function simultaneously as a learning resource, a practical reference, and a working methodology.
