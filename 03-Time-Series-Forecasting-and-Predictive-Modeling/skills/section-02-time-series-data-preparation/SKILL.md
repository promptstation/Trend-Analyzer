---
name: section-02-time-series-data-preparation
description: Develop comprehensive, professional-level learning modules and training materials on data Preparation for Time Series within Time-Series Forecasting & Predictive Modeling — build leakage-proof ingestion and resampling pipelines; detect and treat outliers and missing data by mechanism rather than reflex, engineer calendar and holiday features; apply variance-stabilizing transformations with back-transformation awareness. Use this skill whenever the user asks to create, teach, or deepen training on preparation, series, Time-series forecasting, or requests workshops, lessons, curricula, job aids, or expert instruction in this area — even when the word “module” is never used.
compatibility: Any environment that can write Markdown files; benefits from web research access for authoritative sources; no external tools or packages required.
metadata:
  author: Promptstation skill-building pipeline (Trend Analyzer course 03, section 2)
  version: 1.0.0
  category: professional-education
---

# Data Preparation for Time Series — Professional Training

## Mission

Produce professional-grade learning modules and training materials on **data Preparation for Time Series** within Statistical learning, econometrics, and forecasting science applied to trend trajectory analysis.
...
```markdown
# Data Preparation for Time Series [— audience/context subtitle]
...
The goal is not more content about Time-series forecasting. The goal is that a practitioner could take this material and perform: Build leakage-proof ingestion and resampling pipelines, prepare search-index and social-volume series handling their normalization and sampling peculiarities — with the same evidence discipline the field's best practitioners use. The module must function simultaneously as a learning resource, a practical reference, and a working methodology.
