...
```markdown
# Exponential Smoothing and ARIMA Family [— audience/context subtitle]
...
The goal is not more content about Time-series forecasting. The goal is that a practitioner could take this material and perform: Fit and forecast with ETS/Holt-Winters and ARIMA/SARIMA/SARIMAX models, interpret the forecast functions implied by each model component, and deploy classical methods as rigorous baselines with awareness of their interval fragility — with the same evidence discipline the field's best practitioners use. The module must function simultaneously as a learning resource, a practical reference, and a working methodology.
