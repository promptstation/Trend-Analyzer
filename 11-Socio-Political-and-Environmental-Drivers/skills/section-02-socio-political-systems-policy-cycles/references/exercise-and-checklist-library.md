# Exercise and Checklist Library — Political Systems, Policy Cycles, and the State's Market Power
...
## Exercise 1 — Analyze the state's market instruments (taxes
...
**Objective:** analyze the state's market instruments (taxes, subsidies, standards, procurement) as trend levers with examples.
...
## Exercise 2 — Apply the policy cycle and Kingdon's streams model to forecast windows of policy change
**Scenario:** provide a realistic Socio-political and environmental drivers scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** apply the policy cycle and Kingdon's streams model to forecast windows of policy change.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.

## Exercise 3 — Distinguish announcement from enforcement from market effect across policy lags
**Scenario:** provide a realistic Socio-political and environmental drivers scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** distinguish announcement from enforcement from market effect across policy lags.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.

## Exercise 4 — Compare precautionary and risk-based regulatory regimes' market consequences
**Scenario:** provide a realistic Socio-political and environmental drivers scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** compare precautionary and risk-based regulatory regimes' market consequences.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.

## Exercise 5 — Operate policy-watching (bills
**Scenario:** provide a realistic Socio-political and environmental drivers scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** operate policy-watching (bills, consultations, rulemaking, lobbying disclosures) as early-warning practice.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.
...
## B1. Analyze the state's market checklist
- [ ] Analyze the state's market instruments (taxes, subsidies, standards, procurement) as trend levers with examples?
- [ ] Decisions and their justification are documented for review by a colleague

## B2. Apply the policy cycle checklist
- [ ] Apply the policy cycle and Kingdon's streams model to forecast windows of policy change?
- [ ] Decisions and their justification are documented for review by a colleague

## B3. Distinguish announcement from enforcement checklist
- [ ] Distinguish announcement from enforcement from market effect across policy lags?
- [ ] Decisions and their justification are documented for review by a colleague

## B4. Compare precautionary and risk based checklist
- [ ] Compare precautionary and risk-based regulatory regimes' market consequences?
- [ ] Decisions and their justification are documented for review by a colleague

## B5. Operate policy watching (bills, consultations, checklist
- [ ] Operate policy-watching (bills, consultations, rulemaking, lobbying disclosures) as early-warning practice?
- [ ] Decisions and their justification are documented for review by a colleague
