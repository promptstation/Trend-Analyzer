# Exercise and Checklist Library — Synthesis and Capstone: Socio-Political and Environmental Trend Analysis
...
## Exercise 1 — Assess macro drivers through the five-question framework (force
...
**Objective:** assess macro drivers through the five-question framework (force, channel, audience, timeline, countervailing).
...
## Exercise 2 — Execute the driver-impact workflow from detection to scored review
**Scenario:** provide a realistic Socio-political and environmental drivers scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** execute the driver-impact workflow from detection to scored review.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.

## Exercise 3 — Combine slow
**Scenario:** provide a realistic Socio-political and environmental drivers scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** combine slow, medium, and fast drivers in layered multi-speed assessments.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.

## Exercise 4 — Produce impact-assessment deliverables with scenarios
**Scenario:** provide a realistic Socio-political and environmental drivers scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** produce impact-assessment deliverables with scenarios, triggers, and strategy translation.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.

## Exercise 5 — Maintain calibration through outcome scoring of past driver judgments
**Scenario:** provide a realistic Socio-political and environmental drivers scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** maintain calibration through outcome scoring of past driver judgments.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.
...
## B1. Assess macro drivers through checklist
- [ ] Assess macro drivers through the five-question framework (force, channel, audience, timeline, countervailing)?
- [ ] Decisions and their justification are documented for review by a colleague

## B2. Execute the driver impact workflow checklist
- [ ] Execute the driver-impact workflow from detection to scored review?
- [ ] Decisions and their justification are documented for review by a colleague

## B3. Combine slow, medium, and checklist
- [ ] Combine slow, medium, and fast drivers in layered multi-speed assessments?
- [ ] Decisions and their justification are documented for review by a colleague

## B4. Produce impact assessment deliverables with checklist
- [ ] Produce impact-assessment deliverables with scenarios, triggers, and strategy translation?
- [ ] Decisions and their justification are documented for review by a colleague

## B5. Maintain calibration through outcome checklist
- [ ] Maintain calibration through outcome scoring of past driver judgments?
- [ ] Decisions and their justification are documented for review by a colleague
