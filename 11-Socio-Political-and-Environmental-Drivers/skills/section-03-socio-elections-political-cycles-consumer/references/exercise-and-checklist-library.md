# Exercise and Checklist Library — Elections, Political Cycles, and Consumer Sentiment
...
## Exercise 1 — Analyze election-cycle uncertainty effects on consumption and investment timing
...
**Objective:** analyze election-cycle uncertainty effects on consumption and investment timing, separate partisan sentiment responses from policy effects in post-election data, track issue-salience shifts as redirections of political-consumption pressure.
...
## Exercise 2 — Read mandates and coalition constraints to forecast policy versus promises
**Scenario:** provide a realistic Socio-political and environmental drivers scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** read mandates and coalition constraints to forecast policy versus promises.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.

## Exercise 3 — Build election-watch assessments covering sentiment
**Scenario:** provide a realistic Socio-political and environmental drivers scenario appropriate to the audience (real or closely modeled on documented practice).
**Objective:** build election-watch assessments covering sentiment, policy, uncertainty, and polarization channels.
**Constraints:** must use the framework taught in the corresponding unit; must state assumptions and trade-offs; one deliverable, length-bounded.
**Deliverable:** the professional artifact this capability produces (memo, table, plan, analysis, or model — as applicable).
**Evaluation criteria:** correct application of the framework; decisions justified with evidence; limitations honestly stated; artifact usable by a colleague without further explanation.
...
## B1. Analyze election cycle uncertainty effects checklist
- [ ] Analyze election-cycle uncertainty effects on consumption and investment timing, separate partisan sentiment responses from policy effects in post-election data, track issue-salience shifts as redirections of political-consumption pressure?
- [ ] Decisions and their justification are documented for review by a colleague

## B2. Read mandates and coalition checklist
- [ ] Read mandates and coalition constraints to forecast policy versus promises?
- [ ] Decisions and their justification are documented for review by a colleague

## B3. Build election watch assessments covering checklist
- [ ] Build election-watch assessments covering sentiment, policy, uncertainty, and polarization channels?
- [ ] Decisions and their justification are documented for review by a colleague
